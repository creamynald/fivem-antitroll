...
Config.Rang = "admintroll"    -- The Rang needed for the Admin Command

Config.HowLong = 1440         -- How Long the Player should have antitroll on
Config.TimeToSave = 5         -- How often the time should be saved in the Database

-- SETTING FOR PLAYERS WITH ANTITROLL ON
Config.DisableVDM = false           -- Disables damage from cars while the player still has Troll Protection. (Players still get demage off the ground)
